...
\href{https://neuralincendio.github.io}{NeuralIncendio web page} function as the main hub for the course. Discussion threads are available at \href{https://github.com/NeuralIncendio}{NeuralIncendio Github page} for questions related to the course and for addressing coding problems or bugs.
